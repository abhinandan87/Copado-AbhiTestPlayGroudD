({
    doInit: function(component, event, helper) {
       ...
       /* component.set('v.columns', [
        ...
        var columnsDefinition=component.get('v.columnDefinitions');
        component.set('v.columns',JSON.parse(columnsDefinition));
        var page = component.get("v.page") || 1;
        helper.getData(component, page);
        if(component.get("v.reportName")!=undefined && component.get("v.reportName")!='') {	
        	helper.fetchReportId(component, page);
        }
    },
