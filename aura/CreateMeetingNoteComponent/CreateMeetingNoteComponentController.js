({
    ...
    //SFDC-2325: 80 character limit check added | Priyanka Vyas | 04-Dec-2019
    addRelatedOpps :function(component,event, helper){
        var meetingNoteObj = component.get("v.meetingNote");
        if(!$A.util.isEmpty(meetingNoteObj.Name) && meetingNoteObj.Name.length>80) {
            helper.displayToast('Error','Meeting Note Name must be less than 80 characters', 'Error');   
        	return;
        }
