            ...
            scrollCheckIntervalId = setInterval($A.getCallback(function() {
                if(didScrolled ) {
                    ...
                    if(div.scrollTop === (div.scrollHeight - div.offsetHeight)) {
                        ...
                        var businessLine = (component.get("v.businessLine")==='--None--' || component.get("v.businessLine")===undefined)?'': component.get("v.businessLine");
                        var subBusinessLine = (component.get("v.subBusinessLine")==='--None--' || component.get("v.subBusinessLine")===undefined)?'': component.get("v.subBusinessLine");
                        var internalBusinessSegment = (component.get("v.internalBusinessSegment")==="--None--" || component.get("v.internalBusinessSegment")===undefined)?'': component.get("v.internalBusinessSegment");
                        var aag = (component.get("v.aag")==="--None--" || component.get("v.aag")===undefined)?'': component.get("v.aag");
                        //SFDC-4730 Change End
                        ...
                        //SFDC-4730 Change End
                        var productGroup = (component.get("v.productGroup")===null || component.get("v.productGroup")===undefined)?'': component.get("v.productGroup");  
                        if(familyName.length>1 ||productName.length>0 ||materialNumber.length>0 
                           ...
                           //SFDC-4730 Change Start
                           //|| internalProductName.length>0 || mediaType.length>0 || productGroup.length>0) {
                           || internalProductName.length>0 || mediaType.length>0 || productGroup.length>0 || internalBusinessSegment.length>0 || aag.length>0) {
                            /*
                            ...
                            */
                            ...
                            action.setParams({ familyName : familyName,                                              
                                              ...
                                              internalBusinessSegment: internalBusinessSegment,
                                              aag: aag,
                              				  //SFDC-4730 Change end
